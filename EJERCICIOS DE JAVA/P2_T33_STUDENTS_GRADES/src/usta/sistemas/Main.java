...
public class Main {
	...
	/*AUTHOR: Jhon Alexis Piracoca Arcos
        DATE: 12/05/2020
       DESCRIPTION: this software Store in a matrix the number of students (10) with which a subject has,
                    with their respective four notes (P1: 20%, P2:25%, P3:25%, P4:30%....
                    Notes are random values between 0.0 and 5.0):
       */
        f_menu();
